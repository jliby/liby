...
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expand");g.V.call(this,{D:"button",W:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],N:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},K:[d]});this.u=a;this.ga("click",this.w,this);this.ia("title",g.WM(a,e,"i"));g.ie(this,g.gN(b.Wa(),this.element))},P5=function(a){g.V.call(this,{D:"div",
I:"ytp-miniplayer-ui"});this.player=a;this.H=!1;this.G=this.B=this.u=void 0;this.L(a,"minimized",this.wH);this.L(a,"onStateChange",this.fO)},Q5=function(a){g.EP.call(this,a);
...
g.h.show=function(){this.u=new g.ln(this.vH,null,this);this.u.start();if(!this.H){this.C=new g.XQ(this.player,this);g.C(this,this.C);g.NL(this.player,this.C.element,4);this.C.B=.6;this.T=new g.YP(this.player);g.C(this,this.T);this.w=new g.V({D:"div",I:"ytp-miniplayer-scrim"});g.C(this,this.w);this.w.ba(this.element);this.L(this.w.element,"click",this.bA);var a=new g.V({D:"button",W:["ytp-miniplayer-close-button","ytp-button"],N:{"aria-label":"Close"},K:[g.pM()]});g.C(this,a);a.ba(this.w.element);
this.L(a.element,"click",this.Ay);a=new O5(this.player,this);g.C(this,a);a.ba(this.w.element);this.A=new g.V({D:"div",I:"ytp-miniplayer-controls"});g.C(this,this.A);this.A.ba(this.w.element);this.L(this.A.element,"click",this.bA);var b=new g.V({D:"div",I:"ytp-miniplayer-button-container"});g.C(this,b);b.ba(this.A.element);a=new g.V({D:"div",I:"ytp-miniplayer-play-button-container"});g.C(this,a);a.ba(this.A.element);var c=new g.V({D:"div",I:"ytp-miniplayer-button-container"});g.C(this,c);c.ba(this.A.element);
...
"ytp-button"],N:{"aria-label":"Close"},K:[g.pM()]});g.C(this,a);a.ba(this.F.element);this.L(a.element,"click",this.Ay);a=new g.V({D:"button",W:["ytp-miniplayer-replay-button","ytp-button"],N:{"aria-label":"Close"},K:[g.EM()]});g.C(this,a);a.ba(this.F.element);this.L(a.element,"click",this.aM);this.L(this.player,"presentingplayerstatechange",this.xH);this.L(this.player,"appresize",this.Vr);this.L(this.player,"fullscreentoggled",this.Vr);this.Vr();this.H=!0}0!=this.player.getPlayerState()&&g.V.prototype.show.call(this);
...
g.h.Ay=function(){this.player.stopVideo();this.player.la("onCloseMiniplayer")};
g.h.aM=function(){this.player.playVideo()};
g.h.bA=function(a){if(a.target==this.w.element||a.target==this.A.element)g.R(this.player.P().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.JD(g.vL(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.la("onExpandMiniplayer")};
g.h.wH=function(){g.L(g.tL(this.player),"ytp-player-minimized",this.player.app.H.o)};
g.h.vH=function(){g.ZN(this.B);this.G.w();this.u&&this.u.start()};
g.h.xH=function(a){g.W(a.state,32)&&this.C.hide()};
g.h.Vr=function(){var a=this.B,b=g.sL(this.player).getPlayerSize().width;a.za=0;a.B=b;a.F=!1;g.aO(a)};
g.h.fO=function(a){this.player.app.H.o&&(0==a?this.hide():this.show())};
